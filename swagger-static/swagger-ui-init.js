...
window.onload = function() {
  ...
  "swaggerDoc": {
    ...
    "paths": {
      ...
      "/api/admin/courseRelation/{courseRelationId}": {
        "put": {
          "operationId": "AdminCourseController_updateCourseRelation",
          "parameters": [
            {
          ...
          "requestBody": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/ReqUpdateCourseRelationDto"
                }
              }
            }
          },
        ...
        "delete": {
          "operationId": "AdminCourseController_deletePrereqCourseCode",
          "parameters": [
            {
              "name": "courseRelationId",
              "required": true,
